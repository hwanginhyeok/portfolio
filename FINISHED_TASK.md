...
| # | 태스크 | 완료일 | 비고 |
|---|--------|--------|------|
| JD-A8 | Apple 지원자료 최종 리뷰 (사용자 직접) | 2026-05-18 | 영문 이력서 5건 수정 적용: BMS 벤더명 익명화(2곳) / TOEIC 재응시 표기 제거 / 필드이슈 60+·37+ 중복 해소 / Awards에서 사내발표 분리 → INTERNAL PRESENTATIONS 신규 섹션 / SUMMARY 단락 3문장 분할. Patent #2 표기는 유지(공동개발, 팀 방침 발명자 미포함). |
