...
> **결정: A (Hero 직하단) + C (별도 /impact 페이지) 병행** (2026-05-04 확정).
> 현재 구현: Hero 3카드(-40°C/특허2건/16대)로 옵션 A 효과 반영. 옵션 C(/impact 페이지)는 B4-02로 분리.
>
> 이유:
...
| 6 | Hero 헤드라인 (H-A/H-B/H-C) | **H-A 확정** — "분야를 막론하고 — 문제가 있으면 해결한다" | 2026-05-04 |
