...
- **참여 과제**: 전동화 차량 구동 전기모터의 상태 진단을 위한 PHM SoC 개발 (산업통상자원부, 2021.04 ~ 2022.10) — 모터 모델링 · 고장 모델링 · 모터 제어 시뮬레이션 · Co-simulation 수행
...
- **GT-SS500 풀사이클 주도** — 알고리즘부터 양산까지. APQP Phase 2~3, DFMEA #201/#210 Step 1~7, BOM 132 항목, 혁신제품 실사 4/9 대응. **2026-04-16 양산 초도 2대 고객 인도(인도조 직접 참여) → 2026-09 누적 고객 인도 5대, 총 제작 계획 21대 중 15대 완료.**
...
- **이슈 트래킹** — 128건(2026-08-31 기준) 중 직접 담당 30건 · 전력제어팀 21건. NCR 1차 27건 + 2차 17건 closed-loop.
- **양산 운영 데이터 인프라** — 호기 관제 파이프라인(현장 폼 → CSV SSOT → Notion → Fleet 사이트), 텔레메트리 SSOT 30분/2시간 동기, CAN 로그 뷰어(70만 샘플 단일 패스). 전부 본인 설계·구현(AI 에이전트 공저).
...
### 5.1 GT-SS500 — 48V 전동 자율주행 Speed Sprayer (2025.01 ~ 2026.04 양산 인도 → 운영 중)

> 농업용 Physical AI 제품. STM32 기반 VCU + 5노드 CAN 분산 제어 + RC/LCD/자율주행 3모드 상태머신 + LiFePO4 BMS + AWS OTA. 전력제어 개발자(본업) + 주니어 PM(겸임)으로 풀사이클 수행.

| 영역 | 정량 성과 |
|------|----------|
| 양산 준비 | APQP Phase 2~3, DFMEA Step 1~7 — FM 25건 중 AP=H 20건(확정 14·초안 6, 2026-08), Boundary Diagram + Assembly 재편 |
| 양산 실적 | 2026-04-16 초도 인도 2대 → 2026-09 고객 인도 5대(농가 4·법인 시험장 1), 제작 15/21대. 1호기는 분사 성능 불만으로 회수 → 시연·개선용 전환(FFR 기록) |
...
| 현장 이슈 | 128건 트래킹(2026-08), 직접 담당 30건, NCR 27+17건 |
...
> 6개팀 Cross-functional facilitation, 이슈 128건 트래킹, NCR 44건(2회), DFMEA AP=H 20건 도출, 고객 인도 5대.

### 옵션 E — 제조기술 / 공정 톤 (자동차 Tier-1 제조기술 · 반도체 장비)

> 제품을 양산 라인으로 넘겨본 개발자. GT-SS500에서 APQP Phase 2~3을 운영해
> DFMEA Step 1~7로 AP=H 20건을 도출하고, BOM 132항목 중 재고 미확보 23건을 일정이
> 깨지기 전에 잡아냈다. 현장 이슈 128건 중 30건을 직접 처리(NCR 44건)했고 근본원인
...
**§5 추가 1줄 카피**: "APQP 5 Phase 풀사이클 PM — DFMEA AP=H 20건 · NCR 44건 · BOM 132 · 6팀 협업 · 고객 인도 5대."
...
**§5 추가 1줄 카피**: "양산 이관 — DFMEA Step 1~7(AP=H 20건) · BOM 132(리스크 23건 선식별) ·
NCR 44건 · 시험체계 4종 자가 설계 · 초도 인도 2026-04."
...
- **사업 임팩트 정량화**: 출하 대수는 확정 — 고객 인도 5대(2026-09) · 제작 15/21대 (HIH_2 Notion `rs-500x-고객-인도-일정`, 2026-09-07). 매출 기여액·단가절감은 `[TODO: 사용자 입력]` — 회사 공개 범위 확인 뒤.
