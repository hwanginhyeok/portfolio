...
> 분석일: 2026-05-04 (v2 — 대학원 신뢰성 배경 반영)
...
| **가속수명시험 (ALT)** | IPMSM ALT — phase current·온도·shaft displacement·진동 4중 센서 모니터링, failure mode 분류 (P-05 J.Power Electron. 2024) |
| **수명 예측** | PV 폴리머 damage summation 접근법 — 변동 환경하 수명 추정 (P-04 Solar Energy 2024) |
| **반도체 신뢰성** | IGBT 본드와이어 lift-off 결함 검출 (P-01 IEEE TIM 2024), 전원사이클 시험 (P-02 PCIM Asia 2022) |
...
| 2 | 신뢰성 테스트 실무 | **O** | 대학원 ALT 설계·운용 + 실무 시험 체계 4종 자력 구축 |
...
| # | 업무 | 매칭 | 근거 |
|---|------|:----:|------|
| 1 | 신뢰성 시험 주도 | **O** | 대학원 ALT + 실무 시험대 자력 구축 4종, APQP Phase 2~3 |
...
| ALT 설계·운용 | 가속수명시험 설계, 다중 센서 failure mode 분류 — 직접 이전 가능 |
| 수명 예측 경험 | damage summation으로 변동 환경 수명 추정 (P-04) |
| 반도체 신뢰성 | IGBT 본드와이어 lift-off 검출 (P-01 IEEE TIM 2024) |
| FA 구조화 역량 | RCA 4건, DFMEA, 교차 기능 시정조치 — Apple FA 업무와 1:1 대응 |
...
- **구체적 사례**: IEEE TIM 2024 (IGBT 신뢰성), 다이나모미터 ALT, DFMEA 4건 RCA
...
| Semiconductor module | IGBT 신뢰성 — P-01 IEEE TIM 2024 |
